...
function Cholesterol_Lipid_Panel_Red_Cases() {
  ...
  return (
    <>
      <Home />
      <br></br>
      <h5 style={{ color: "#ea5455" }}><b>Cholesterol-Lipid Panel Red Cases</b></h5>
      <Box
        sx={(theme) => ({
...
export default Cholesterol_Lipid_Panel_Red_Cases

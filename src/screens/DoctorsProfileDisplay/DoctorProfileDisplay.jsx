...
//                     <Row className="field d-flex">
//                         <Col lg={3} md={6} sm={12}><span>Photo:</span></Col>
//                         <Col lg={3} md={6} sm={12}><img src="" alt="Doctor's Photo" className="img-fluid photo" /></Col>
//                         <Col lg={3} md={6} sm={12}><span>Signature:</span></Col>
//                         <Col lg={3} md={6} sm={12}><img src="" alt="Doctor's Signature" className="img-fluid signature" /></Col>
//                     </Row>
//                     <Row className='mt-3'>
//                         <Col lg={6} md={6} sm={12}>
//                             {profileInfo.slice(0, 8).map((field, index) => (

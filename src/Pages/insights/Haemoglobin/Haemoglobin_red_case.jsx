...
function Haemoglobin_red_case() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Haemoglobin Red Case</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"Haemoglobin red cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Haemoglobin_red_case

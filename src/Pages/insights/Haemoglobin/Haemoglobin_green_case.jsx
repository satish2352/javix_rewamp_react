...
function Haemoglobin_green_case() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Haemoglobin Green Case</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"Haemoglobin green cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Haemoglobin_green_case

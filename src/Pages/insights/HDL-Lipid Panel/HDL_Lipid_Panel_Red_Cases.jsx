...
function HDL_Lipid_Panel_Red_Cases() {
    ...
    return (
        <>
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>HDL-Lipid Panel Red Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"HDL red cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default HDL_Lipid_Panel_Red_Cases

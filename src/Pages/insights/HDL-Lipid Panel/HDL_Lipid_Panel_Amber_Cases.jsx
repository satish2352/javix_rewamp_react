...
function HDL_Lipid_Panel_Amber_Cases() {
    ...
    return (
        <>
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>HDL-Lipid Panel Amber Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"HDL Amber cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default HDL_Lipid_Panel_Amber_Cases

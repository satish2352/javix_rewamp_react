...
function Blood_Glucose_Red_Cases() {
  ...
  return (
    <>
      ...
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Blood Glucose Red Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"Blood Glucose red cases"} />
              </Box>
            </Box>
          </Box>
...
export default Blood_Glucose_Red_Cases

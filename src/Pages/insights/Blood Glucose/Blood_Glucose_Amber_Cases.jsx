...
function Blood_Glucose_Amber_Cases() {
  ...
  return (
    <>
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Blood Glucose Amber Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"Blood Glucose Amber cases"} />
              </Box>
            </Box>
          </Box>
...
export default Blood_Glucose_Amber_Cases

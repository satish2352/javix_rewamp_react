...
function Right_Eye_Tests_Red_case() {
  ...
  return (
    <>
      ...
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Right Eye Tests Red case</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"rght eye red cases"} />
              </Box>
            </Box>
          </Box>
...
export default Right_Eye_Tests_Red_case

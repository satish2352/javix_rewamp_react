...
function Blood_Pressure_Amber_Cases() {
    ...
    const handleActivateUser = (row) => {
        ...
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Blood Pressure Amber Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        <Box>
                            <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                <Export_Button data={data} name={"Blood Pressure Amber cases"}/>
                            </Box>
                        </Box>
                    </Box>
...
export default Blood_Pressure_Amber_Cases

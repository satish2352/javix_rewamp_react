...
function LDL_Lipid_Panel_Green_cases() {
  ...
  return (
    <>
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>LDL-Lipid Panel Green Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"LDL green cases"} />
              </Box>
            </Box>
          </Box>
...
export default LDL_Lipid_Panel_Green_cases

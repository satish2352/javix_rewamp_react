...
function Heart_Rate_Green_Cases() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Heart Rate Green Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        <Box>
                            <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                <Export_Button data={data} name={"Heart Rate green cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Heart_Rate_Green_Cases

...
function Heart_Rate_Amber_Cases() {
    ...
    return (
        <>
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Heart Rate Amber Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        <Box>
                            <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                <Export_Button data={data} name={"Heart Rate Amber cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Heart_Rate_Amber_Cases

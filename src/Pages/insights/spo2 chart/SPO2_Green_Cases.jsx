...
function SPO2_Green_Cases() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card>
                    <p style={{ color: "black", fontSize: '20px' }}>SPO2 Green Cases</p>
                    <Box
                        sx={(theme) => ({
                        ...
                        <Box>
                            <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                >
                                 ...
                                 <Export_Button data={data} name={"SPo2 green cases"}/>
                            </Box>
                        </Box>
                    </Box>
...
export default SPO2_Green_Cases

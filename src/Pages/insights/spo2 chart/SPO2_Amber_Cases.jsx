...
function SPO2_Amber_Cases() {
    ...
    return (
        <>
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>SPO2 Amber Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        <Box>
                            <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                                ...
                                <Export_Button data={data} name={"SPo2 Amber cases"}/>
                            </Box>
                        </Box>
                    </Box>
...
export default SPO2_Amber_Cases

...
function Temperature_Amber_Cases() {
    ...
    return (
        <>
            <p style={{ color: "black", fontSize: '20px' }}>Temperature Amber Cases</p>
            <Box
                sx={(theme) => ({
            ...
            >
                ...
                <Box>
                    <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                        ...
                        <Export_Button data={data} name={"Temparature amber cases"}/>
                    </Box>
                </Box>
            </Box>
            <br></br>
...
export default Temperature_Amber_Cases

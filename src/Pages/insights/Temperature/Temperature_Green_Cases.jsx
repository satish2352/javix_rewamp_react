...
function Temperature_Green_Cases() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Temperature Green Cases</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"Temparature green cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Temperature_Green_Cases

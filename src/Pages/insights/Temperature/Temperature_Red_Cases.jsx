...
function Temperature_Red_Cases() {
  ...
  return (
    <>
      ...
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Temperature Red Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            <Box>
              <Box sx={{ display: 'flex', gap: '0.5rem' }}>
                ...
                <Export_Button data={data} name={"Temparature red cases"} />
              </Box>
            </Box>
          </Box>
...
export default Temperature_Red_Cases

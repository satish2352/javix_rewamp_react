...
import './Triglycerides_Lipid_panel.scss';
...
function Triglycerides_Lipid_Panel_green_cases() {
  ...
  return (
    <>
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Triglycerides Panel Green Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"Triglycerides sgreen cases"} />
              </Box>
            </Box>
          </Box>
...
export default Triglycerides_Lipid_Panel_green_cases

...
function Triglycerides_Lipid_Panel_red_cases() {
  ...
  return (
    <>
      ...
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Triglycerides Panel Red Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"Triglycerides red cases"} />
              </Box>
            </Box>
          </Box>
...
export default Triglycerides_Lipid_Panel_red_cases

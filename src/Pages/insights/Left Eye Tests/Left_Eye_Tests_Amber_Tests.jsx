...
function Left_Eye_Tests_Amber_Tests() {
  ...
  return (
    <>
      ...
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Left Eye Tests Amber Cases</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"left eye amber cases"} />
              </Box>
            </Box>
          </Box>
          <br></br>
...
export default Left_Eye_Tests_Amber_Tests

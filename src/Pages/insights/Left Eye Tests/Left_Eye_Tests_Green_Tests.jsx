...
function Left_Eye_Tests_Green_Tests() {
    ...
    return (
        <>
            ...
            <Card className='mt-3'>
                <Card.Body>
                    <p style={{ color: "black", fontSize: '20px' }}>Left Eye Tests Green case</p>
                    <Box
                        sx={(theme) => ({
                    ...
                    >
                        ...
                        >
                            Deactivate
                                ...
                                <Export_Button data={data} name={"left eye green cases"} />
                            </Box>
                        </Box>
                    </Box>
...
export default Left_Eye_Tests_Green_Tests

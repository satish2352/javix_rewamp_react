...
function Haemoglobin_amber_case() {
  ...
  return (
    <>
      <Card className='mt-3'>
        <Card.Body>
          <p style={{ color: "black", fontSize: '20px' }}>Haemoglobin Amber case</p>
          <Box
            sx={(theme) => ({
          ...
          >
            ...
            >
              Deactivate
                ...
                <Export_Button data={data} name={"Haemoglobin amber cases"} />
              </Box>
            </Box>
          </Box>
...
export default Haemoglobin_amber_case
